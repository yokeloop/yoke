...
- On the first call, read CLAUDE.md and `.claude/yoke-context.md` (if they exist) for stack and convention context. On subsequent calls — the information is already in `{{PREVIOUS_FINDINGS}}`
