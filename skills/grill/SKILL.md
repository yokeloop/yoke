...
- 2–4 options. **Put the recommended answer first, labelled `(Recommended)`**, with a one-line rationale in its description. Make the remaining options the strongest realistic alternatives.
