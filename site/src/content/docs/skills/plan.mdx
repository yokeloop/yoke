---
title: /yoke:plan
description: "Builds an implementation plan from a task file."
---

Builds an implementation plan from a task file.
...
**Input:** `$ARGUMENTS` — path to the task file produced by `/yoke:task`.
...
[View `SKILL.md` on GitHub →](https://github.com/yokeloop/yoke/blob/main/skills/plan/SKILL.md)
