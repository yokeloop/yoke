...
Анализирует изменённые файлы, классифицирует по группам (feature, test, docs, style, chore), формирует атомарные коммиты с Conventional Commits на английском. Определяет ticket ID из аргументов, ветки или SP flow. Внутри flow -- коммитит артефакты автоматически.
...
│   ├── gca/                 # git commit с умной группировкой
│   │   ├── SKILL.md
│   │   └── reference/       # commit-convention (shared), staging-strategy
