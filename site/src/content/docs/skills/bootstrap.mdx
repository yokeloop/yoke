...
description: "Prepares a project for the yoke flow — stack detection, generation of CLAUDE.md and yoke-context.md."
---

Prepares a project for the yoke flow — stack detection, generation of CLAUDE.md and yoke-context.md.
