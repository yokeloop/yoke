...
or yoke flow; classifies files into groups; and formats messages per Conventional Commits.
Works in two modes: yoke flow (commit an artifact) and standalone (group files).
