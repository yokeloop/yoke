---
title: /yoke:draft
description: "Projects the agreed plan onto the code as Markup — TODO markers plus a compilable skeleton — and opens a Draft PR for review, instead of implementing."
---
...
**Input:** `$ARGUMENTS` — the same contract as `/do`, plus the iteration shapes:
...
[View `SKILL.md` on GitHub →](https://github.com/yokeloop/yoke/blob/main/skills/draft/SKILL.md)
