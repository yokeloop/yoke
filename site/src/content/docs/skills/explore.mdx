---
title: /yoke:explore
description: "Codebase exploration and brainstorming."
---

Codebase exploration and brainstorming.
...
**Input:** `$ARGUMENTS` — the first question or topic. If empty, asks via AskUserQuestion.
...
[View `SKILL.md` on GitHub →](https://github.com/yokeloop/yoke/blob/main/skills/explore/SKILL.md)
