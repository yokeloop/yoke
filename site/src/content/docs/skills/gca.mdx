---
title: /yoke:gca
description: "Git staging and commit with smart file grouping."
---

Git staging and commit with smart file grouping.
...
**Input:** `$ARGUMENTS` (optional) — ticket ID, ticket URL, or slug.
...
[View `SKILL.md` on GitHub →](https://github.com/yokeloop/yoke/blob/main/skills/gca/SKILL.md)
