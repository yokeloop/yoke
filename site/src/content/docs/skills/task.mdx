---
title: /yoke:task
description: "Drafts a task file for AI implementation."
---

Drafts a task file for AI implementation.
...
- `task from ticket`
- `draft a task`
- `prepare an implementation prompt`
...
**Input:** `$ARGUMENTS` — ticket URL (GitHub Issues, YouTrack, Jira) and/or a free-form task description.
...
[View `SKILL.md` on GitHub →](https://github.com/yokeloop/yoke/blob/main/skills/task/SKILL.md)
