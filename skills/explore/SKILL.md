...
Build CONTEXT as the orchestrator — based on the flow of the conversation, previous questions and the user's current goal.
...
The agent will create the file `.yoke/ai/<SLUG>/<SLUG>-exploration.md`.
...
- Run phases without confirmations; use AskUserQuestion in Init and Loop.
