---
title: /yoke:fix
description: "Quick fix or follow-up change."
---

Quick fix or follow-up change.
...
**Input:** `$ARGUMENTS` — fix description or PR comment URL.
...
[View `SKILL.md` on GitHub →](https://github.com/yokeloop/yoke/blob/main/skills/fix/SKILL.md)
