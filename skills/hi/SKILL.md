...
Анализирует изменённые файлы, классифицирует по группам, формирует атомарные коммиты с Conventional Commits на английском. Определяет ticket ID из аргументов, ветки или SP flow.
